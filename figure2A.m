%% Figure 2A: upshift transition from steady low to steady high
...
%  Commit: add plot lambda, tau and birth vol across shift (time)
...
save('B1_ccSize.mat','compiled_data','compiled_mu','exptArray')
...
clear range_lambda range_sizes range_times combined range_tau
...
for mm = 1:length(conditions) % condition
    ...
    t_steady = [0 2.5 timeVector_final(end)];
