%% Figure 7B: downshift transition from steady high to steady low (tau)
...
bt = 13;   % column in compiled_data that is timestamp at birth
tau = 11;  % column in compiled_data that is interdivision time, tau
